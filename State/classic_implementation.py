...
State - a pattern in which the object's behavior is
determined by it's state. An object transitions
from one state to another (something needs to trigger a transition).

A formalized construct which manages state
and transitions is called a State Machine.
